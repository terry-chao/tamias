...
框选 / 点选的索引选型（BVH vs R-tree）与十万构件以上的分层索引见 [空间索引](SPATIAL-INDEX.md)。
...
| [occt/occt_mesh.cpp](https://github.com/terry-chao/tamias/blob/main/src/engine/modeling/occt/occt_mesh.cpp) `tessellate_brep` | 按 Face 出网并记下范围 | 按 deflection 多档 + 按面剔除 |
