...
| 三维视口 | 看模型、转相机、点选 | [`document_viewport`](https://github.com/terry-chao/tamias/blob/main/src/app/viewport/canvas/document_viewport.cpp) |
| 视口右侧工具列 | 从视口右缘到右停靠面板之间、上下通高的一列：左边是按钮（2D/3D、构件显隐、楼层、适应窗口），点开后右边展开对应功能页 | [`viewport_tool_panel`](https://github.com/terry-chao/tamias/blob/main/src/app/viewport/panel/viewport_tool_panel.cpp) |
