...
启动：`main()` → [`register_opengl_backend()`](https://github.com/terry-chao/tamias/blob/main/src/app/base/rhi_backends.cpp) 登记工厂。视口 `acquire(OpenGL)` 才真正 `wglCreateContextAttribsARB` 做出 **OpenGL 4.5 Core**。
